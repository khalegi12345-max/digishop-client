...
import { X, User, LogOut, ChevronRight, Moon, Sun, Mail, ShoppingBag, Edit3, Headphones, Info } from 'lucide-react'
    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="bg-white w-80 h-full shadow-xl flex flex-col">
        ...
        <div className="flex justify-between items-center px-6 py-5 border-b border-gray-100">
          {section !== 'main' ? (
            <button onClick={() => setSection('main')} className="text-blue-700 text-sm font-medium">
              ← برگشت
            </button>
          ) : (
            ...
            <div className="flex flex-col px-4 py-4 gap-1">
              ...
              <button className="flex items-center justify-between px-4 py-3 rounded-xl hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">سفارشات من</span>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">ظاهر و تنظیمات</span>
                </div>
                <ChevronRight size={16} className="text-gray-400" />
              </button>
        ...
        {section === 'edit' && (
          <div className="flex flex-col flex-1 px-6 py-4 gap-4">
            <h3 className="font-bold text-gray-900 mb-2">ویرایش پروفایل</h3>
            ...
            <button className="w-full bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 rounded-xl transition-colors mt-2">
              ذخیره تغییرات
            </button>
          </div>
        )}
        ...
        {section === 'appearance' && (
          <div className="flex flex-col flex-1 px-6 py-4 gap-4">
            ...
            <div className="flex items-center justify-between px-4 py-4 bg-gray-50 rounded-xl">
              <div className="flex items-center gap-3">
                {darkMode ? <Moon size={20} className="text-blue-700" /> : <Sun size={20} className="text-yellow-500" />}
          ...
          <div className="flex flex-col flex-1 px-6 py-4 gap-4">
            ...
            <div className="flex items-center gap-3 px-4 py-4 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-700">support@digishop.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 px-4 py-4 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-700">دیجی‌شاپ نسخه ۱.۰</p>
              </div>
            </div>
          </div>
        )}
