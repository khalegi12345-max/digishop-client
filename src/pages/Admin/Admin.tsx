...
function Admin() {
  ...
  const fetchProducts = async () => {
    const res = await fetch(
      "https://digishop-server.onrender.com/api/products",
    );
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input
                ...
                className="border border-gray-200 rounded-xl px-4 py-3 text-sm col-span-2"
              />
              <textarea
                placeholder="توضیحات"
            ...
            <button
              onClick={handleAdd}
              className="mt-4 bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold"
            >
              اضافه کن
            </button>
          </div>
